...
router.post('/test', (req, res) => {
    async function a() {
        var results = await repair.select(Number(req.body.uid))
...
router.post('/add', (req, res) => {
    ...
    async function a() {
        res.json(await repair.add(user))
    }
    a()
})
...
router.post('/edit', (req, res) => {
    async function a() {
        res.json(await repair.edit(req))
    }
    a()
})
...
router.post('/confirm', (req, res) => {
    async function a() {
        res.json(await repair.confirm(req))
    }
    a()
})
...
router.post('/delete', (req, res) => {
    async function a() {
        res.json(await repair.deleteinfo(req))
    }
    a()
})
