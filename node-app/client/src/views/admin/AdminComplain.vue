...
export default {
    ...
    methods:{
        getRepair(){
            ...
            this.$axios.post('/api/admincomplain/selw',this.$store.getters.user)
            .then(res=>{
            ...
            this.$axios.post('/api/admincomplain/seli',this.$store.getters.user)
            .then(res=>{
            ...
            .catch(err=>console.log(err))
            this.$axios.post('/api/admincomplain/selc',this.$store.getters.user)
            .then(res=>{
